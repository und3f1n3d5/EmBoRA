...
def compute_summary_by_condition(episode_rows: Sequence[Dict[str, Any]]) -> List[Dict[str, Any]]:
    group_keys = [
        "scenario_name", "game_name", "run_profile", "condition_id", "condition_label",
...
def compute_summary_for_paper(summary_rows: Sequence[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    for row in summary_rows:
        ...
        out.append({
            ...
            "interpretation_guardrail": "Descriptive result only; do not claim full superiority or H2 confirmation from this table alone.",
        })
    return out
